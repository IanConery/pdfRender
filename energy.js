...
$(document).ready(function(){
  ...
  for(var i = 0; i < utility.length; i++){
    ...
    var utilityUsage = fourDeci(cur.utilityBillUsage);
    var utilityPeak = fourDeci(cur.utilityBillDemandKw);
    $('#utility-details').append('<table class="table table-noborder inner-utility"><thead><th>Meter: ' + (i + 1) + '</th></thead><tbody><tr><td>Meter Name:</td><td>' + utilityName + '</td></tr><tr><td>Meter Number:</td><td>' + utilityNumber + '</td></tr><tr><td>Usage:</td><td>' + utilityUsage + ' kWh</td></tr><tr><td>Peak Demand:</td><td>' + utilityPeak + ' kWh</td></tr></tbody></table>');
  }
  //end utility details
